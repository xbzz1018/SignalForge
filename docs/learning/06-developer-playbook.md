...
| `.moagent/skills/` | 当前 Agent 的 source-first 编译输入，受 registry/lock、版本与 SHA-256 完整性校验；workspace `.moagent/skills/` 只是项目初始化参考镜像 |
| `docs/` | 项目知识、教学和排障 |
...
| 生成能力 | Agent 反复生成不好看的页面或用错数据 | 仓库 Skill 权威源 `.moagent/skills/`、MoAgent 编译器和评测用例 |
