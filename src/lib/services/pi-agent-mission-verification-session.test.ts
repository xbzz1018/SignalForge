...
vi.mock('@/lib/services/pi-agent-mission-store', () => ({
  beginPiAgentMissionVerification: mocks.begin,
  heartbeatPiAgentMissionVerification: mocks.heartbeat,
  abandonPiAgentMissionVerification: mocks.abandon,
}));

import { PiAgentMissionVerificationSession } from './pi-agent-mission-verification-session';
...
async function claimSession() {
  return PiAgentMissionVerificationSession.claim({
...
describe('PI Agent Mission verification session', () => {
