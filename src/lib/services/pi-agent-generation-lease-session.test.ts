...
vi.mock('@/lib/services/pi-agent-generation-lease-store', () => ({
  claimPiAgentGenerationLease: mocks.claim,
  heartbeatPiAgentGenerationLease: mocks.heartbeat,
  releasePiAgentGenerationLease: mocks.release,
}));

import {
  PiAgentGenerationLeaseSession,
  withPiAgentGenerationLease,
} from './pi-agent-generation-lease-session';
...
async function claimSession() {
  return PiAgentGenerationLeaseSession.claimProject(
    {
...
describe('PI Agent generation lease session', () => {
